...
function commentCreate(){
	...
	console.log($("#comment-content-btn-done").val())
    $.ajax({
        type: "post",
        url: "/comment/api/comment/list",
        //data: {"comment": $("#comment").val(),"board_id": $("#board_id").val()},
...
/* 
	//저장 버튼의 활성화 
    $('#comment-update-btn-done').on("click", function(item){
    	console.log("저장버튼 클릭");
        // 작성한 댓글을 수정하고 저장시  
        let commentUpdate = $("#comment-content").val();
        if (commentUpdate === "") {
            alert("작성된 댓글이 없습니다");
        } else {
            commentSave();
                        ...
                        <div class="row">    
                         <c:forEach items="${commentList}" var="list" >                      	                                                                                   
                            ...
                            <div class="col-xs-10 col-md-11">
                                ...
                                <div class="action">                                                                 
                                    <textarea id="comment-update" style="height:100px;" class="form-control" placeholder="글을 수정해주세요." name = "comment-update" hidden="true">${list.commentContent}</textarea>
                                    
                                    <button type="button" id="comment-update-btn" class="btn btn-primary btn-xs" class ="slideToggle" title="Update">
                                    ...
                                    <button type="button" id="comment-update-btn-done" class="btn btn-primary btn-xs" title="Delete">
